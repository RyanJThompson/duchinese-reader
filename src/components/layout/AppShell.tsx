    ...
    <div className="min-h-screen flex flex-col">
      <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center">
          ...
          <Link
            to="/recents"
            className="ml-auto mr-3 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
          ...
          <a
            href="/api/logout"
            className="mr-3 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
            title="Sign out"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex items-center gap-0.5 border border-gray-200 dark:border-gray-700 rounded-lg p-0.5">
            <button onClick={() => setTheme('light')} className={btnClass(theme === 'light')} title="Light">
              <SunIcon />
            </button>
            <button onClick={() => setTheme('auto')} className={btnClass(theme === 'auto')} title="Auto">
              <MonitorIcon />
            </button>
            <button onClick={() => setTheme('dark')} className={btnClass(theme === 'dark')} title="Dark">
              <MoonIcon />
            </button>
          </div>
        </div>
